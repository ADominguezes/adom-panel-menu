...
/* ======================================================================================================
* Task for insert estiles en el adom-panel-menu-styles.html
* ======================================================================================================*/
gulp.task('styles-replace', ['styles'], function () {
    return gulp.src('./adom-panel-menu-styles.html')
        .pipe(replace(/<style>[^>]*<\/style>/, function (s) {
            var style = fs.readFileSync('./dist/css/adom-panel-menu.css', 'utf8');
            return '<style>\n' + style + '\n</style>';
        }))
        .pipe(gulp.dest('./'))
        .pipe(browserSync.stream());
...
gulp.task('serve', ['styles-replace', 'styles', 'watch'], function () {
    browserSync.init({
        injectChanges: true,
        files: ['./*.{html, scss}', './demo/index.html', './adom-panel-menu.js', './dist/css/adom-panel-menu.css'],
        server: "./",
    });
});

/* ======================================================================================================
* watch changes in files adom-panel-menu.scss and adom-panel-menu.html
* ======================================================================================================*/
gulp.task('watch', function () {
    gulp.watch('./adom-panel-menu.html', ['styles-replace']); // Vigila cambios en el html
    gulp.watch('./dist/css/adom-panel-menu.css', ['styles-replace']); // Vigila cambios en el html
